...
namespace ThingMagic.URA2.BL
{
    ...
    public class TagReadRecord : INotifyPropertyChanged
    {
        ...
        public string Data
        {
            get
            {
                if ((Protocol == TagProtocol.ISO14443A) || (Protocol == TagProtocol.ISO14443B) || (Protocol == TagProtocol.ISO15693) || (Protocol == TagProtocol.ISO180003M3) || (Protocol == TagProtocol.LF125KHZ) || (Protocol == TagProtocol.LF134KHZ))
                {

    ...
    class AutonomousMode
    {
        static void Usage()
        {
            Console.WriteLine(String.Join("\r\n", new string[] {
                    ...
                    " Example for UHF: 'tmr:///com4 --enable/disable' or 'tmr:///com4 --ant 1,2 --enable/disable' or '-v tmr:///com4 --ant 1,2 --enable/disable'",
                " Example for HF/LF: 'tmr:///com4 --enable/disable'"
            }));
            Environment.Exit(1);
        }
